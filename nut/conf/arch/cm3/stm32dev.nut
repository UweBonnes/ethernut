...
--                sources = { "cm3/dev/stm/stm32_usart.c" }
    ...
    --
    {
        ...
        brief = "USB OTG",
        description = "Generic port I/O API.",
        requires = { "HW_MCU_STM32", "HW_OTG1_STM32" },
        sources = { "cm3/dev/stm/stm32_otg.c",
    ...
    --
    {
        ...
        brief = "USB OTG1",
        description = "Generic port I/O API.",
        requires = { "HW_MCU_STM32", "HW_OTG2_STM32" },
        sources = { "cm3/dev/stm/stm32_otg.c",
                    "cm3/dev/stm/stm32_usb_init.c",
                    "cm3/dev/stm/stm32_usb_istr.c",
                    "cm3/dev/stm/stm32_usb_prop.c",
    ...
    --
    {
        ...
        provides = { "DEV_UART",
                     ...
                     "DEV_UART1_GPIO_CTS",
                     "DEV_UART1_GPIO_HDX" },
        sources = { "cm3/dev/stm/stm32_usart1.c",
...
--            },
    ...
    --
    {
        ...
        provides = { "DEV_UART",
                     ...
                     "DEV_UART2_GPIO_CTS",
                     "DEV_UART2_GPIO_HDX" },
        sources = { "cm3/dev/stm/stm32_usart2.c",
...
--            },
	...
	--
	{
		...
		provides = { "DEV_UART",
                     ...
                     "DEV_UART3_GPIO_CTS",
                     "DEV_UART3_GPIO_HDX" },
		sources = { "cm3/dev/stm/stm32_usart3.c",
...
--            },
	...
	--
    {
        ...
        provides = { "DEV_UART",
					 ...
					 "DEV_UART_SPECIFIC",
                     "DEV_UART4_GPIO_HDX" },
        sources = { "cm3/dev/stm/stm32_uart4.c",
...
--            },
	...
	--
    {
        ...
        provides = { "DEV_UART",
        			 "DEV_UART_SPECIFIC",
                     "DEV_UART5_GPIO_HDX" },
        sources = { "cm3/dev/stm/stm32_uart5.c",
...
--            },
	...
	--
    {
        ...
        provides = { "DEV_TWI" },
        sources = { "cm3/dev/stm/stm32_twi1.c",
...
--				requires = { "NOT_AVAILABLE" },
	...
	--
    {
        ...
        provides = { "DEV_TWI" },
        sources = { "cm3/dev/stm/stm32_twi2.c",
...
--				requires = { "NOT_AVAILABLE" },
    ...
    --
    {
        ...
        provides = { "DEV_CAN" },
        sources = { "cm3/dev/stm/stm32_can1.c",
    ...
    },
    {
        ...
        provides = { "DEV_CAN" },
        sources = { "cm3/dev/stm/stm32_can2.c",
