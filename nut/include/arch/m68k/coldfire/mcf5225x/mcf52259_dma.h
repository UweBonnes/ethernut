...
#define MCF_DMA0_SAR                         (*(volatile uint32_t*)(0x40000100))
#define MCF_DMA0_DAR                         (*(volatile uint32_t*)(0x40000104))
#define MCF_DMA0_DSR                         (*(volatile uint8_t *)(0x40000108))
#define MCF_DMA0_BCR                         (*(volatile uint32_t*)(0x40000108))
#define MCF_DMA0_DCR                         (*(volatile uint32_t*)(0x4000010C))

#define MCF_DMA1_SAR                         (*(volatile uint32_t*)(0x40000110))
#define MCF_DMA1_DAR                         (*(volatile uint32_t*)(0x40000114))
#define MCF_DMA1_DSR                         (*(volatile uint8_t *)(0x40000118))
#define MCF_DMA1_BCR                         (*(volatile uint32_t*)(0x40000118))
#define MCF_DMA1_DCR                         (*(volatile uint32_t*)(0x4000011C))

#define MCF_DMA2_SAR                         (*(volatile uint32_t*)(0x40000120))
#define MCF_DMA2_DAR                         (*(volatile uint32_t*)(0x40000124))
#define MCF_DMA2_DSR                         (*(volatile uint8_t *)(0x40000128))
#define MCF_DMA2_BCR                         (*(volatile uint32_t*)(0x40000128))
#define MCF_DMA2_DCR                         (*(volatile uint32_t*)(0x4000012C))

#define MCF_DMA3_SAR                         (*(volatile uint32_t*)(0x40000130))
#define MCF_DMA3_DAR                         (*(volatile uint32_t*)(0x40000134))
#define MCF_DMA3_DSR                         (*(volatile uint8_t *)(0x40000138))
#define MCF_DMA3_BCR                         (*(volatile uint32_t*)(0x40000138))
#define MCF_DMA3_DCR                         (*(volatile uint32_t*)(0x4000013C))

#define MCF_DMA_SAR(x)                       (*(volatile uint32_t*)(0x40000100 + ((x)*0x10)))
#define MCF_DMA_DAR(x)                       (*(volatile uint32_t*)(0x40000104 + ((x)*0x10)))
#define MCF_DMA_DSR(x)                       (*(volatile uint8_t *)(0x40000108 + ((x)*0x10)))
#define MCF_DMA_BCR(x)                       (*(volatile uint32_t*)(0x40000108 + ((x)*0x10)))
#define MCF_DMA_DCR(x)                       (*(volatile uint32_t*)(0x4000010C + ((x)*0x10)))
