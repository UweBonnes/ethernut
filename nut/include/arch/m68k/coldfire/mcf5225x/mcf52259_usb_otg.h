...
#define MCF_USB_OTG_PER_ID                   (*(volatile uint8_t *)(0x401C0000))
#define MCF_USB_OTG_ID_COMP                  (*(volatile uint8_t *)(0x401C0004))
#define MCF_USB_OTG_REV                      (*(volatile uint8_t *)(0x401C0008))
#define MCF_USB_OTG_ADD_INFO                 (*(volatile uint8_t *)(0x401C000C))
#define MCF_USB_OTG_OTG_INT_STAT             (*(volatile uint8_t *)(0x401C0010))
#define MCF_USB_OTG_OTG_INT_EN               (*(volatile uint8_t *)(0x401C0014))
#define MCF_USB_OTG_OTG_STAT                 (*(volatile uint8_t *)(0x401C0018))
#define MCF_USB_OTG_OTG_CTRL                 (*(volatile uint8_t *)(0x401C001C))
#define MCF_USB_OTG_INT_STAT                 (*(volatile uint8_t *)(0x401C0080))
#define MCF_USB_OTG_INT_ENB                  (*(volatile uint8_t *)(0x401C0084))
#define MCF_USB_OTG_ERR_STAT                 (*(volatile uint8_t *)(0x401C0088))
#define MCF_USB_OTG_ERR_ENB                  (*(volatile uint8_t *)(0x401C008C))
#define MCF_USB_OTG_STAT                     (*(volatile uint8_t *)(0x401C0090))
#define MCF_USB_OTG_CTL                      (*(volatile uint8_t *)(0x401C0094))
#define MCF_USB_OTG_ADDR                     (*(volatile uint8_t *)(0x401C0098))
#define MCF_USB_OTG_BDT_PAGE_01              (*(volatile uint8_t *)(0x401C009C))
#define MCF_USB_OTG_FRM_NUML                 (*(volatile uint8_t *)(0x401C00A0))
#define MCF_USB_OTG_FRM_NUMH                 (*(volatile uint8_t *)(0x401C00A4))
#define MCF_USB_OTG_TOKEN                    (*(volatile uint8_t *)(0x401C00A8))
#define MCF_USB_OTG_SOF_THLD                 (*(volatile uint8_t *)(0x401C00AC))
#define MCF_USB_OTG_BDT_PAGE_02              (*(volatile uint8_t *)(0x401C00B0))
#define MCF_USB_OTG_BDT_PAGE_03              (*(volatile uint8_t *)(0x401C00B4))
#define MCF_USB_OTG_ENDPT0                   (*(volatile uint8_t *)(0x401C00C0))
#define MCF_USB_OTG_ENDPT1                   (*(volatile uint8_t *)(0x401C00C4))
#define MCF_USB_OTG_ENDPT2                   (*(volatile uint8_t *)(0x401C00C8))
#define MCF_USB_OTG_ENDPT3                   (*(volatile uint8_t *)(0x401C00CC))
#define MCF_USB_OTG_ENDPT4                   (*(volatile uint8_t *)(0x401C00D0))
#define MCF_USB_OTG_ENDPT5                   (*(volatile uint8_t *)(0x401C00D4))
#define MCF_USB_OTG_ENDPT6                   (*(volatile uint8_t *)(0x401C00D8))
#define MCF_USB_OTG_ENDPT7                   (*(volatile uint8_t *)(0x401C00DC))
#define MCF_USB_OTG_ENDPT8                   (*(volatile uint8_t *)(0x401C00E0))
#define MCF_USB_OTG_ENDPT9                   (*(volatile uint8_t *)(0x401C00E4))
#define MCF_USB_OTG_ENDPT10                  (*(volatile uint8_t *)(0x401C00E8))
#define MCF_USB_OTG_ENDPT11                  (*(volatile uint8_t *)(0x401C00EC))
#define MCF_USB_OTG_ENDPT12                  (*(volatile uint8_t *)(0x401C00F0))
#define MCF_USB_OTG_ENDPT13                  (*(volatile uint8_t *)(0x401C00F4))
#define MCF_USB_OTG_ENDPT14                  (*(volatile uint8_t *)(0x401C00F8))
#define MCF_USB_OTG_ENDPT15                  (*(volatile uint8_t *)(0x401C00FC))
#define MCF_USB_OTG_USB_CTRL                 (*(volatile uint8_t *)(0x401C0100))
#define MCF_USB_OTG_USB_OTG_OBSERVE          (*(volatile uint8_t *)(0x401C0104))
#define MCF_USB_OTG_USB_OTG_CONTROL          (*(volatile uint8_t *)(0x401C0108))
#define MCF_USB_OTG_ENDPT(x)                 (*(volatile uint8_t *)(0x401C00C0 + ((x)*0x4)))

/* Other macros */
#define MCF_USB_OTG_FRM_NUM                  (MCF_USB_OTG_INT_STAT=MCF_USB_OTG_INT_STAT_SOF_TOK ,MCF_USB_OTG_FRM_NUML | (((volatile uint16_t)MCF_USB_OTG_FRM_NUMH)<<8))
