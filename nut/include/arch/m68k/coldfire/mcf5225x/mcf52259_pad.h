...
#define MCF_PAD_PSRR0                        (*(volatile uint32_t*)(0x40100078))
#define MCF_PAD_PDSR0                        (*(volatile uint32_t*)(0x4010007C))
#define MCF_PAD_PSRR1                        (*(volatile uint32_t*)(0x40100080))
#define MCF_PAD_PSRR2                        (*(volatile uint16_t*)(0x40100086))
#define MCF_PAD_PDSR1                        (*(volatile uint32_t*)(0x40100088))
#define MCF_PAD_PDSR2                        (*(volatile uint16_t*)(0x4010008E))
