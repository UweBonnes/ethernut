...
#define MCF_FBCS0_CSAR                       (*(volatile uint32_t*)(0x40000080))
#define MCF_FBCS0_CSMR                       (*(volatile uint32_t*)(0x40000084))
#define MCF_FBCS0_CSCR                       (*(volatile uint32_t*)(0x40000088))

#define MCF_FBCS1_CSAR                       (*(volatile uint32_t*)(0x4000008C))
#define MCF_FBCS1_CSMR                       (*(volatile uint32_t*)(0x40000090))
#define MCF_FBCS1_CSCR                       (*(volatile uint32_t*)(0x40000094))
