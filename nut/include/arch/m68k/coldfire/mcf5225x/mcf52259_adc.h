...
#define MCF_ADC_CTRL1                        (*(volatile uint16_t*)(0x40190000))
#define MCF_ADC_CTRL2                        (*(volatile uint16_t*)(0x40190002))
#define MCF_ADC_ADZCC                        (*(volatile uint16_t*)(0x40190004))
#define MCF_ADC_ADLST1                       (*(volatile uint16_t*)(0x40190006))
#define MCF_ADC_ADLST2                       (*(volatile uint16_t*)(0x40190008))
#define MCF_ADC_ADSDIS                       (*(volatile uint16_t*)(0x4019000A))
#define MCF_ADC_ADSTAT                       (*(volatile uint16_t*)(0x4019000C))
#define MCF_ADC_ADLSTAT                      (*(volatile uint16_t*)(0x4019000E))
#define MCF_ADC_ADZCSTAT                     (*(volatile uint16_t*)(0x40190010))
#define MCF_ADC_ADRSLT0                      (*(volatile uint16_t*)(0x40190012))
#define MCF_ADC_ADRSLT1                      (*(volatile uint16_t*)(0x40190014))
#define MCF_ADC_ADRSLT2                      (*(volatile uint16_t*)(0x40190016))
#define MCF_ADC_ADRSLT3                      (*(volatile uint16_t*)(0x40190018))
#define MCF_ADC_ADRSLT4                      (*(volatile uint16_t*)(0x4019001A))
#define MCF_ADC_ADRSLT5                      (*(volatile uint16_t*)(0x4019001C))
#define MCF_ADC_ADRSLT6                      (*(volatile uint16_t*)(0x4019001E))
#define MCF_ADC_ADRSLT7                      (*(volatile uint16_t*)(0x40190020))
#define MCF_ADC_ADLLMT0                      (*(volatile uint16_t*)(0x40190022))
#define MCF_ADC_ADLLMT1                      (*(volatile uint16_t*)(0x40190024))
#define MCF_ADC_ADLLMT2                      (*(volatile uint16_t*)(0x40190026))
#define MCF_ADC_ADLLMT3                      (*(volatile uint16_t*)(0x40190028))
#define MCF_ADC_ADLLMT4                      (*(volatile uint16_t*)(0x4019002A))
#define MCF_ADC_ADLLMT5                      (*(volatile uint16_t*)(0x4019002C))
#define MCF_ADC_ADLLMT6                      (*(volatile uint16_t*)(0x4019002E))
#define MCF_ADC_ADLLMT7                      (*(volatile uint16_t*)(0x40190030))
#define MCF_ADC_ADHLMT0                      (*(volatile uint16_t*)(0x40190032))
#define MCF_ADC_ADHLMT1                      (*(volatile uint16_t*)(0x40190034))
#define MCF_ADC_ADHLMT2                      (*(volatile uint16_t*)(0x40190036))
#define MCF_ADC_ADHLMT3                      (*(volatile uint16_t*)(0x40190038))
#define MCF_ADC_ADHLMT4                      (*(volatile uint16_t*)(0x4019003A))
#define MCF_ADC_ADHLMT5                      (*(volatile uint16_t*)(0x4019003C))
#define MCF_ADC_ADHLMT6                      (*(volatile uint16_t*)(0x4019003E))
#define MCF_ADC_ADHLMT7                      (*(volatile uint16_t*)(0x40190040))
#define MCF_ADC_ADOFS0                       (*(volatile uint16_t*)(0x40190042))
#define MCF_ADC_ADOFS1                       (*(volatile uint16_t*)(0x40190044))
#define MCF_ADC_ADOFS2                       (*(volatile uint16_t*)(0x40190046))
#define MCF_ADC_ADOFS3                       (*(volatile uint16_t*)(0x40190048))
#define MCF_ADC_ADOFS4                       (*(volatile uint16_t*)(0x4019004A))
#define MCF_ADC_ADOFS5                       (*(volatile uint16_t*)(0x4019004C))
#define MCF_ADC_ADOFS6                       (*(volatile uint16_t*)(0x4019004E))
#define MCF_ADC_ADOFS7                       (*(volatile uint16_t*)(0x40190050))
#define MCF_ADC_POWER                        (*(volatile uint16_t*)(0x40190052))
#define MCF_ADC_CAL                          (*(volatile uint16_t*)(0x40190054))
#define MCF_ADC_ADRSLT(x)                    (*(volatile uint16_t*)(0x40190012 + ((x)*0x2)))
#define MCF_ADC_ADLLMT(x)                    (*(volatile uint16_t*)(0x40190022 + ((x)*0x2)))
#define MCF_ADC_ADHLMT(x)                    (*(volatile uint16_t*)(0x40190032 + ((x)*0x2)))
#define MCF_ADC_ADOFS(x)                     (*(volatile uint16_t*)(0x40190042 + ((x)*0x2)))
