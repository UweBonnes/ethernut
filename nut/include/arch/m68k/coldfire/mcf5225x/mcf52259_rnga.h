...
#define MCF_RNGA_RNGCR                       (*(volatile uint32_t*)(0x401F0000))
#define MCF_RNGA_RNGSR                       (*(volatile uint32_t*)(0x401F0004))
#define MCF_RNGA_RNGER                       (*(volatile uint32_t*)(0x401F0008))
#define MCF_RNGA_RNGOUT                      (*(volatile uint32_t*)(0x401F000C))
