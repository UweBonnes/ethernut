...
#define MCF_PIT0_PCSR                        (*(volatile uint16_t*)(0x40150000))
#define MCF_PIT0_PMR                         (*(volatile uint16_t*)(0x40150002))
#define MCF_PIT0_PCNTR                       (*(volatile uint16_t*)(0x40150004))

#define MCF_PIT1_PCSR                        (*(volatile uint16_t*)(0x40160000))
#define MCF_PIT1_PMR                         (*(volatile uint16_t*)(0x40160002))
#define MCF_PIT1_PCNTR                       (*(volatile uint16_t*)(0x40160004))
