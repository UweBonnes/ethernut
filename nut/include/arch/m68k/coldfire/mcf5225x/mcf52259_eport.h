...
#define MCF_EPORT_EPPAR                      (*(volatile uint16_t*)(0x40130000))
#define MCF_EPORT_EPDDR                      (*(volatile uint8_t *)(0x40130002))
#define MCF_EPORT_EPIER                      (*(volatile uint8_t *)(0x40130003))
#define MCF_EPORT_EPDR                       (*(volatile uint8_t *)(0x40130004))
#define MCF_EPORT_EPPDR                      (*(volatile uint8_t *)(0x40130005))
#define MCF_EPORT_EPFR                       (*(volatile uint8_t *)(0x40130006))
