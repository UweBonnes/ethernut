...
#define MCF_CFM_CFMMCR                       (*(volatile uint16_t*)(0x401D0000))
#define MCF_CFM_CFMCLKD                      (*(volatile uint8_t *)(0x401D0002))
#define MCF_CFM_CFMSEC                       (*(volatile uint32_t*)(0x401D0008))
#define MCF_CFM_CFMPROT                      (*(volatile uint32_t*)(0x401D0010))
#define MCF_CFM_CFMSACC                      (*(volatile uint32_t*)(0x401D0014))
#define MCF_CFM_CFMDACC                      (*(volatile uint32_t*)(0x401D0018))
#define MCF_CFM_CFMUSTAT                     (*(volatile uint8_t *)(0x401D0020))
#define MCF_CFM_CFMCMD                       (*(volatile uint8_t *)(0x401D0024))
#define MCF_CFM_CFMCLKSEL                    (*(volatile uint16_t*)(0x401D004A))
