...
#define MCF_I2C0_I2ADR                       (*(volatile uint8_t *)(0x40000300))
#define MCF_I2C0_I2FDR                       (*(volatile uint8_t *)(0x40000304))
#define MCF_I2C0_I2CR                        (*(volatile uint8_t *)(0x40000308))
#define MCF_I2C0_I2SR                        (*(volatile uint8_t *)(0x4000030C))
#define MCF_I2C0_I2DR                        (*(volatile uint8_t *)(0x40000310))

#define MCF_I2C1_I2ADR                       (*(volatile uint8_t *)(0x40000380))
#define MCF_I2C1_I2FDR                       (*(volatile uint8_t *)(0x40000384))
#define MCF_I2C1_I2CR                        (*(volatile uint8_t *)(0x40000388))
#define MCF_I2C1_I2SR                        (*(volatile uint8_t *)(0x4000038C))
#define MCF_I2C1_I2DR                        (*(volatile uint8_t *)(0x40000390))
