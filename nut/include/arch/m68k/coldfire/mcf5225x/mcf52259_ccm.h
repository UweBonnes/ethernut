...
#define MCF_CCM_CCR                          (*(volatile uint16_t*)(0x40110004))
#define MCF_CCM_RCON                         (*(volatile uint16_t*)(0x40110008))
#define MCF_CCM_CIR                          (*(volatile uint16_t*)(0x4011000A))
#define MCF_CCM_CCE                          (*(volatile uint16_t*)(0x40110010))
