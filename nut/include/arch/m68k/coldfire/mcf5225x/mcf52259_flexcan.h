...
#define MCF_FlexCAN_CANMCR                   (*(volatile uint32_t*)(0x40170000))
#define MCF_FlexCAN_CANCTRL                  (*(volatile uint32_t*)(0x40170004))
#define MCF_FlexCAN_TIMER                    (*(volatile uint32_t*)(0x40170008))
#define MCF_FlexCAN_RXGMASK                  (*(volatile uint32_t*)(0x40170010))
#define MCF_FlexCAN_RX14MASK                 (*(volatile uint32_t*)(0x40170014))
#define MCF_FlexCAN_RX15MASK                 (*(volatile uint32_t*)(0x40170018))
#define MCF_FlexCAN_ERRCNT                   (*(volatile uint32_t*)(0x4017001C))
#define MCF_FlexCAN_ERRSTAT                  (*(volatile uint32_t*)(0x40170020))
#define MCF_FlexCAN_IMASK                    (*(volatile uint32_t*)(0x40170028))
#define MCF_FlexCAN_IFLAG                    (*(volatile uint32_t*)(0x40170030))
