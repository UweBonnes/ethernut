...
/*!
 * Adjust the external high speed oscillator (HSE) frequency.
 * Can be overridden by nutconf.
  */
#if !defined(HSE_VALUE)
 #ifdef STM32F10X_CL
  #define HSE_VALUE    ((uint32_t)25000000) /*!< Value of the External oscillator in Hz */
 #else
#define HSE_VALUE    ((uint32_t)8000000) /*!< Value of the ixternal oscillator in Hz */
 #endif /* STM32F10X_CL */
#endif /* HSE_VALUE */

/*!
 * Adjust the internal oscillator (HSI) startup timeout value.
 */
#define HSI_VALUE    ((uint32_t)8000000) /*!< Value of the Internal oscillator in Hz*/

/*!
 * \brief Adjust the oscillator (HSE) startup timeout value.
   */
...
#define DEV_ESIG_BASE         ((uint32_t)0x1FFFF7E0)    /*!< Device Electronic Signature base address */
...
#define  USART_CR1_TXEIE                     ((uint16_t)0x0080)            /*!<TX Interrupt Enable */
