...
/* Converts Nut/OS PIO-ID (0..n) to STM32 GPIO adresses */
#define GPIO_ID2BASE(id) ((id*0x00000400)+GPIOA_BASE)
#define GPIO_ID2GPIO(id) ((GPIO_TypeDef*)(GPIO_ID2BASE(id)))

/* Convert STM32 GPIOx_BASE to Nut/OS PIO_ID */
#define GPIO_BASE2ID(bs) (((bs&0x00002C00)-0x00000400)>>10)
/* Convert RCC Bit from PIO_ID */
#define GPIO_ID2RCC(id)  _BV(GPIO_BASE2ID(id)+2)
/**
  * @}
  */
#endif
