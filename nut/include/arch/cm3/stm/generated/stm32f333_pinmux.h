/* Do not edit!
 * Generated from /opt/stm/STM32CubeMX/db/mcu/IPGPIO-STM32F333_gpio_v1_0_Modes.xml*/

#if !defined(_STM32F333_PINMUX_H_)
# define _STM32F333_PINMUX_H_
...
#define HRTIM1_CHA1_FUNC         6
#define HRTIM1_CHA2_FUNC         7
#define HRTIM1_CHB1_FUNC         8
#define HRTIM1_CHB2_FUNC         9
#define HRTIM1_CHC1_FUNC         10
#define HRTIM1_CHC2_FUNC         11
#define HRTIM1_CHD1_FUNC         12
#define HRTIM1_CHD2_FUNC         13
#define HRTIM1_CHE1_FUNC         14
#define HRTIM1_CHE2_FUNC         15
#define HRTIM1_EEV1_FUNC         16
#define HRTIM1_EEV10_FUNC        17
#define HRTIM1_EEV2_FUNC         18
#define HRTIM1_EEV3_FUNC         19
#define HRTIM1_EEV4_FUNC         20
#define HRTIM1_EEV5_FUNC         21
#define HRTIM1_EEV6_FUNC         22
#define HRTIM1_EEV7_FUNC         23
#define HRTIM1_EEV8_FUNC         24
#define HRTIM1_EEV9_FUNC         25
#define HRTIM1_FLT1_FUNC         26
#define HRTIM1_FLT2_FUNC         27
#define HRTIM1_FLT3_FUNC         28
#define HRTIM1_FLT4_FUNC         29
#define HRTIM1_FLT5_FUNC         30
#define HRTIM1_SCIN_FUNC         31
#define HRTIM1_SCOUT_FUNC        32
#define I2C1_SCL_FUNC            33
#define I2C1_SDA_FUNC            34
#define I2C1_SMBA_FUNC           35
#define IR_OUT_FUNC              36
#define OPAMP2_DIG_FUNC          37
#define RCC_MCO_FUNC             38
#define SPI1_MISO_FUNC           39
#define SPI1_MOSI_FUNC           40
#define SPI1_NSS_FUNC            41
#define SPI1_SCK_FUNC            42
#define SYS_JTCK_SWCLK_FUNC      43
#define SYS_JTDI_FUNC            44
#define SYS_JTDO_TRACESWO_FUNC   45
#define SYS_JTMS_SWDIO_FUNC      46
#define SYS_NJTRST_FUNC          47
#define TIM15_BKIN_FUNC          48
#define TIM15_CH1_FUNC           49
#define TIM15_CH1N_FUNC          50
#define TIM15_CH2_FUNC           51
#define TIM16_BKIN_FUNC          52
#define TIM16_CH1_FUNC           53
#define TIM16_CH1N_FUNC          54
#define TIM17_BKIN_FUNC          55
#define TIM17_CH1_FUNC           56
#define TIM17_CH1N_FUNC          57
#define TIM1_BKIN_FUNC           58
#define TIM1_BKIN2_FUNC          59
...
#define TSC_SYNC_FUNC            102
#define USART1_CK_FUNC           103
#define UART1_CK_FUNC            103
#define USART1_CTS_FUNC          104
#define UART1_CTS_FUNC           104
#define USART1_DE_FUNC           105
#define UART1_DE_FUNC            105
#define USART1_RTS_FUNC          106
#define UART1_RTS_FUNC           106
#define USART1_RX_FUNC           107
#define UART1_RX_FUNC            107
#define USART1_TX_FUNC           108
#define UART1_TX_FUNC            108
#define USART2_CK_FUNC           109
#define UART2_CK_FUNC            109
#define USART2_CTS_FUNC          110
#define UART2_CTS_FUNC           110
#define USART2_DE_FUNC           111
#define UART2_DE_FUNC            111
#define USART2_RTS_FUNC          112
#define UART2_RTS_FUNC           112
#define USART2_RX_FUNC           113
#define UART2_RX_FUNC            113
#define USART2_TX_FUNC           114
#define UART2_TX_FUNC            114
#define USART3_CK_FUNC           115
#define UART3_CK_FUNC            115
#define USART3_CTS_FUNC          116
#define UART3_CTS_FUNC           116
#define USART3_DE_FUNC           117
#define UART3_DE_FUNC            117
#define USART3_RTS_FUNC          118
#define UART3_RTS_FUNC           118
#define USART3_RX_FUNC           119
#define UART3_RX_FUNC            119
#define USART3_TX_FUNC           120
#define UART3_TX_FUNC            120
...
# define PINMUX(gpio, func) ((gpio == PIN_NONE) ? AF_PIN_NONE : 	\
	...
	((gpio == PA06) && (func == OPAMP2_DIG_FUNC          )) ? 13 : \
	...
	((gpio == PA08) && (func == HRTIM1_CHA1_FUNC         )) ? 13 : \
	...
	((gpio == PA09) && (func == HRTIM1_CHA2_FUNC         )) ? 13 : \
	...
	((gpio == PA10) && (func == HRTIM1_CHB1_FUNC         )) ? 13 : \
	...
	((gpio == PA11) && (func == HRTIM1_CHB2_FUNC         )) ? 13 : \
	...
	((gpio == PA12) && (func == HRTIM1_FLT1_FUNC         )) ? 13 : \
	...
	((gpio == PA15) && (func == HRTIM1_FLT2_FUNC         )) ? 13 : \
	...
	((gpio == PB01) && (func == HRTIM1_SCOUT_FUNC        )) ? 13 : \
	((gpio == PB01) && (func == EVENTOUT_FUNC            )) ? 15 : \
	((gpio == PB02) && (func == TSC_G3_IO4_FUNC          )) ?  3 : \
	((gpio == PB02) && (func == HRTIM1_SCIN_FUNC         )) ? 13 : \
	...
	((gpio == PB03) && (func == HRTIM1_SCOUT_FUNC        )) ? 12 : \
	((gpio == PB03) && (func == HRTIM1_EEV9_FUNC         )) ? 13 : \
	...
	((gpio == PB04) && (func == HRTIM1_EEV7_FUNC         )) ? 13 : \
	...
	((gpio == PB05) && (func == HRTIM1_EEV6_FUNC         )) ? 13 : \
	...
	((gpio == PB06) && (func == HRTIM1_SCIN_FUNC         )) ? 12 : \
	((gpio == PB06) && (func == HRTIM1_EEV4_FUNC         )) ? 13 : \
	...
	((gpio == PB07) && (func == HRTIM1_EEV3_FUNC         )) ? 13 : \
	...
	((gpio == PB08) && (func == HRTIM1_EEV8_FUNC         )) ? 13 : \
	...
	((gpio == PB09) && (func == HRTIM1_EEV5_FUNC         )) ? 13 : \
	...
	((gpio == PB10) && (func == HRTIM1_FLT3_FUNC         )) ? 13 : \
	...
	((gpio == PB11) && (func == HRTIM1_FLT4_FUNC         )) ? 13 : \
	...
	((gpio == PB12) && (func == HRTIM1_CHC1_FUNC         )) ? 13 : \
	...
	((gpio == PB13) && (func == HRTIM1_CHC2_FUNC         )) ? 13 : \
	...
	((gpio == PB14) && (func == HRTIM1_CHD1_FUNC         )) ? 13 : \
	...
	((gpio == PB15) && (func == HRTIM1_CHD2_FUNC         )) ? 13 : \
